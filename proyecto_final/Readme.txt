...
Carpeta AppFinal:
contiene los modelos, forms, vistas, urls, etc

Carpeta proyecto_final:
contiene configuraciones, urls generales, etc

templates:
contiene todos los archivos html (formularios, busqueda formulario, los templates de las class de los models)

static:
contiene archivos css, js, assets 

carpeta base:
contiene herencia de html

index.html:
archivo que tiene la plantilla general de la pagina web

db.sqlite3:
archivo de la base de datos

manage.py:
archivo donde se generan las migraciones
